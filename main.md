...
**Tasks:**
- [x] Create another folder specifically for the Japanese codebase (e.g., `japanese/`).
- [x] Move or duplicate necessary codebase files into this new folder.
- [x] Ensure the project can cleanly support multiple codebase languages.
